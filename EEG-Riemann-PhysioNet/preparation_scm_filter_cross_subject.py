'''
#####################################################################################################################
Discription: Preprocessing of Physionet on cross-subject data(calculating SCM and Riemannian mean)
#######################################################################################################################
'''
...
riemann_mean_path = f'data/20-Subjects/all_riemann_mean_filter_cross.mat'
...
scm = np.concatenate(all_scm, axis=0)
